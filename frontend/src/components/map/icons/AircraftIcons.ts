...
export const svgEthNode = `data:image/svg+xml;utf8,${encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"><polygon points="12,2 22,12 12,22 2,12" fill="#0e7490" stroke="#67e8f9" stroke-width="1.5"/><polygon points="12,6 17,12 12,18 7,12" fill="#06b6d4" stroke="#cffafe" stroke-width="0.5"/></svg>`)}`;

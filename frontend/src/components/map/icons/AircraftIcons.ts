...
// Per-type power plant icons (coloured by fuel group)
export const svgPowerPlantNuclear = `data:image/svg+xml;utf8,${encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><circle cx="12" cy="12" r="3" fill="#e879f9"/><ellipse cx="12" cy="12" rx="10" ry="4" fill="none" stroke="#e879f9" stroke-width="1.5"/><ellipse cx="12" cy="12" rx="10" ry="4" fill="none" stroke="#e879f9" stroke-width="1.5" transform="rotate(60,12,12)"/><ellipse cx="12" cy="12" rx="10" ry="4" fill="none" stroke="#e879f9" stroke-width="1.5" transform="rotate(120,12,12)"/></svg>`)}`;
export const svgPowerPlantFossil = `data:image/svg+xml;utf8,${encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path d="M12 2C10 6 7 8 8 12c1 4 4 5 4 5s3-1 4-5c1-4-2-6-4-10z" fill="#fb923c"/><path d="M10 14c0 2 1 4 2 5 1-1 2-3 2-5" fill="#78350f"/></svg>`)}`;
export const svgPowerPlantRenewable = `data:image/svg+xml;utf8,${encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" fill="#14532d" stroke="#4ade80" stroke-width="1.5" stroke-linejoin="round"/></svg>`)}`;
export const svgPowerPlantOther = `data:image/svg+xml;utf8,${encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><rect x="4" y="4" width="16" height="16" rx="3" fill="#1e293b" stroke="#94a3b8" stroke-width="1.5"/><line x1="8" y1="12" x2="16" y2="12" stroke="#94a3b8" stroke-width="1.5"/><line x1="12" y1="8" x2="12" y2="16" stroke="#94a3b8" stroke-width="1.5"/></svg>`)}`;
